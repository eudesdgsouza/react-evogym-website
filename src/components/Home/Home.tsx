            ...
            <div className='z-10 mt-32 md:basis-3/5'>
              ...
              <motion.div className='md:-mt-20' initial='hidden' whileInView='visible' viewport={{once: true, amount: 0.5}} transition={{duration: 0.5}} variants={{hidden: {opacity: 0, x:-50}, visible: {opacity:1, x:0}}}>
                  ...
                  <p className='text-sm mt-8'>
                    Ginásio incomparável. Aulas de fitness de treinamento incomparáveis. Classe Mundial
                    Estúdios para obter as formas corporais que você sonha.
                    Corpo agora.
                  </p>
              </motion.div>
              {/* Actions */}
              <motion.div className='mt-8 flex items-center gap-8' initial='hidden' whileInView='visible' viewport={{once: true, amount: 0.5}} transition={{delay: 0.2, duration: 0.5}} variants={{hidden: {opacity: 0, x:-50}, visible: {opacity:1, x:0}}}>
                <ActionButton setSelectedPage={setSelectedPage}>Cadastre-se agora</ActionButton>
                <AnchorLink href={`${SelectedPage.ContactUs}`} className='text-sm font-bold text-primary-500 underline hover:text-secondary-500 cursor-pointer' onClick={() => setSelectedPage(SelectedPage.ContactUs)} ><p>Saber mais</p></AnchorLink>
              </motion.div>
            </div>
